module.exports = {
    ...
    imagePicture: '#bigpic',
    blackColourImageUpdated:'http://automationpractice.com/img/p/1/5/15-large_default.jpg',
	  orangeColourImageUpdated: 'http://automationpractice.com/img/p/1/4/14-large_default.jpg',
    blueColourImageUpdated: 'http://automationpractice.com/img/p/1/3/13-large_default.jpg',
    yellowColourImageUpdated: 'http://automationpractice.com/img/p/1/2/12-large_default.jpg',
    ...
    productPageUrl: 'http://automationpractice.com/index.php?id_product=5&controller=product',
    checkout: '#layer_cart > div.clearfix > div.layer_cart_cart.col-xs-12.col-md-6 > div.button-container > a > span',
